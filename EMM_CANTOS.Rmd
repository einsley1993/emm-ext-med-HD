...
### Effect modification by baseline logCRP in mediator model, and age & diabetes in outcome model 
#### 1. Specify low and high risk groups' covariate levels
```{r}
